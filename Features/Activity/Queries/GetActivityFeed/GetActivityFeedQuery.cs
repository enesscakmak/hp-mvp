...
namespace IncidentDashboard.Features.Activity.Queries.GetActivityFeed
{
    public class GetActivityFeedQuery : IRequest<IEnumerable<object>>
    {
    }

    public class GetActivityFeedQueryHandler : IRequestHandler<GetActivityFeedQuery, IEnumerable<object>>
    {
        private readonly AppDbContext _context;

        public GetActivityFeedQueryHandler(AppDbContext context)
        {
            _context = context;
        }

        public async Task<IEnumerable<object>> Handle(GetActivityFeedQuery request, CancellationToken cancellationToken)
        {
